...
} -Property @{ Title = 'CredentialPicker'; MinHeight = 233; MinWidth = 377; }

#dialog with a place to request credentials (initially blank)

.LINK
https://docs.microsoft.com/en-us/dotnet/api/system.management.automation.pscredential.getnetworkcredential
#>
